            ...
            "layers": {
                ...
                "USGS Supergages": {
                    ...
                    "wimOptions": {
                        ...
                        "includeInLayerList": true,
                        "includeLegend" : true,
                        "toolTip": "Super gages are USGS streamgage sites with real-time, continuous measurements of the basic physical and chemical characteristics of water such as temperature and pH as well as measurements from advanced water quality instrumentation for nutrients and fluorescence.  Discrete samples are also collected for laboratory analysis and possible statistical surrogate model development.",
                        "selectionSymbol": new SimpleFillSymbol(SimpleFillSymbol.STYLE_SOLID,
                            new SimpleLineSymbol(SimpleLineSymbol.STYLE_DASHDOT,
                                new Color([255, 0, 0]), 2), new Color([255, 255, 0, 0.5]))
                    }
